...
def normalization(normalize=__imagenet_stats):
    t_list = [
        transforms.ToTensor(),
...
def center_crop(input_size, normalize=__imagenet_stats):
    t_list = [
...
def get_transform(name='imagenet', input_size=None,
    ...
    if name == 'imagenet':
        ...
        if augment:
            ...
            return center_crop(input_size, normalize)
    elif name == 'damagenet':
        normalize = __imagenet_stats
        ...
        if augment:
            ...
            return scale_crop(input_size=input_size,
                              scale_size=scale_size, normalize=normalize)
    elif name == 'single_ori':
        return center_crop(input_size=224)
    elif name == 'single_adv':
...
class Grayscale(object):
    ...
    def __call__(self, img):
        ...
        gs[0] = gs[0]*0.299 + gs[1]*0.587 + gs[2]*0.114
        gs[1].copy_(gs[0])
        gs[2].copy_(gs[0])
        return gs
